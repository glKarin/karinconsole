 ...
 */
class TerminalDisplay : public QGraphicsWidget
{
   Q_OBJECT
...
public:
    ...
    TerminalDisplay(QGraphicsWidget *parent=0);
...
public slots:
    ...
    void viewportPositionChanged(int newCurrentLine, bool atEndOfOutput);
...
signals:
     ...
     */
    void configureRequest( TerminalDisplay*, int state, const QPointF& position );

    /** 
     * Emitted when scrolling/panning should be updated
     */
    void scrollChanged(int currentLine, int maxLines);
...
protected:
    ...
    virtual void extendSelection( const QPointF& pos );
    ...
    void mouseTripleClickEvent(QGraphicsSceneMouseEvent* ev);
...
protected:
    ...
    void drawContents(QPainter &paint, const QRectF &rect);
...
public:
    AutoScrollHandler(QGraphicsWidget* parent);
protected:
    virtual void timerEvent(QTimerEvent* event);
    virtual bool eventFilter(QObject* watched,QEvent* event);
    qreal scrollBeginTopY() const;
    qreal scrollBeginBottomY() const;
