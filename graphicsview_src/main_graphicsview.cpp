 ...
 * terminal widget.
 */
class MyTermWidget : public QGraphicsTermWidget
{
    // Q_OBJECT
public:
    MyTermWidget(int startnow = 1, QGraphicsWidget *parent = 0):
        QGraphicsTermWidget(startnow, parent)
    {
...
int main(int argc, char *argv[])
{
    ...
    QGraphicsTermWidget *console = new MyTermWidget(false, 0);
